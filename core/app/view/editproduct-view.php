...
<?php endif;?>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Codigo de producto*</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <textarea name="description" class="form-control" id="description" placeholder="Descripcion del Producto" required><?php echo $product->description;?></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" name="price_in" class="form-control" value="<?php echo $product->price_in; ?>" id="price_in" placeholder="Precio de entrada" required>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Precio de Salida*</label>
    <div class="col-md-8">
      <input type="text" name="price_out" class="form-control" id="price_out" value="<?php echo $product->price_out; ?>" placeholder="Precio de salida" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" name="inventary_min" class="form-control" value="<?php echo $product->inventary_min;?>" id="inputEmail1" placeholder="Minima en Inventario (Default 10)" required>
    </div>
  </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="is_active" <?php if($product->is_active){ echo "checked";}?> required> 
    </label>
  </div>
    </div>
  </div>
