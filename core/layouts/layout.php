...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Active Cell | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>ACTIVE</b>CELL</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2020 <a href="http://www.mimedellinshop.com/" target="_blank">Active Cell</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
